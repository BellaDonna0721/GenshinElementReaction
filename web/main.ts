...
// C++ 布局（32B）:
//  [0,12):  x, y, radius (3*float=12B)
//  [12,16): r,g,b,a (4*uint8=4B)
//  [16,20): entity_type, element_type, reaction_type, _pad1 (4B)
//  [20,24): element_gauge (float)
//  [24,28): facing_dx (float)
//  [28,32): facing_dy (float)
const STRIDE = 32;
